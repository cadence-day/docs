revoke delete on table "extensions"."wrappers_fdw_stats" from "postgres";

revoke insert on table "extensions"."wrappers_fdw_stats" from "postgres";

revoke references on table "extensions"."wrappers_fdw_stats" from "postgres";

revoke select on table "extensions"."wrappers_fdw_stats" from "postgres";

revoke trigger on table "extensions"."wrappers_fdw_stats" from "postgres";

revoke truncate on table "extensions"."wrappers_fdw_stats" from "postgres";

revoke update on table "extensions"."wrappers_fdw_stats" from "postgres";

drop extension if exists "pg_net";

drop policy "notifications_delete" on "internal"."notifications";

drop policy "notifications_insert" on "internal"."notifications";

drop policy "notifications_update" on "internal"."notifications";

drop policy "notifications_user_access" on "internal"."notifications";
...
revoke delete on table "internal"."notifications" from "authenticated";

revoke insert on table "internal"."notifications" from "authenticated";

revoke select on table "internal"."notifications" from "authenticated";

revoke update on table "internal"."notifications" from "authenticated";
...
alter table "internal"."notifications" drop constraint "notifications_pkey";

drop index if exists "internal"."notifications_pkey";

drop index if exists "internal"."notifications_user_id_idx";

drop table "internal"."notifications";
