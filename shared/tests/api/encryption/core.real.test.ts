...
describe("Encryption Utils", () => {
    ...
    describe("Key management", () => {
        test("should check if encryption key exists", async () => {
            require("expo-secure-store").getItemAsync.mockResolvedValue(
                "some-key",
            );
    ...
    describe("Error handling", () => {
        test("should throw EncryptionError on SecureStore failure", async () => {
            ...
            await expect(encryptString("test")).rejects.toThrow(
                EncryptionError,
            );
        });
        ...
        test("should throw EncryptionError with context", async () => {
            ...
            try {
                ...
                expect((error as EncryptionError).message).toContain(
                    "[Encryption]",
                );
            }
        });
