...
describe("Notes API - CRUD Operations", () => {
    ...
    const mockHandleApiError = errorHandler
        ...
        >;
    const mockDecryptNoteMessage = encryptionNotes
        .decryptNoteMessage as jest.MockedFunction<
            typeof encryptionNotes.decryptNoteMessage
        >;
    const mockEncryptNoteForInsertion = encryptionNotes
        .encryptNoteForInsertion as jest.MockedFunction<
            typeof encryptionNotes.encryptNoteForInsertion
        >;
    const mockEncryptNotesForInsertion = encryptionNotes
        .encryptNotesForInsertion as jest.MockedFunction<
            typeof encryptionNotes.encryptNotesForInsertion
        >;
    const mockEncryptNoteMessage = encryptionNotes
        .encryptNoteMessage as jest.MockedFunction<
    ...
    describe("Insert Operations", () => {
        describe("insertNote", () => {
            it("should insert a single note successfully", async () => {
                ...
                mockEncryptNoteForInsertion.mockResolvedValue(
                    mockEncryptedNote,
                );
                ...
                expect(mockEncryptNoteForInsertion).toHaveBeenCalledWith(
                    mockNoteInput,
                );
                expect(mockApiCall).toHaveBeenCalledWith(expect.any(Function));
                expect(mockDecryptNoteMessage).toHaveBeenCalledWith(
                    mockInsertedNote,
                );
    ...
    describe("Update Operations", () => {
        describe("updateNote", () => {
            it("should update a note successfully", async () => {
                ...
                expect(mockEncryptNoteMessage).toHaveBeenCalledWith(
                    mockUpdatedNote,
                );
                expect(mockApiCall).toHaveBeenCalledWith(expect.any(Function));
                expect(mockDecryptNoteMessage).toHaveBeenCalledWith(
