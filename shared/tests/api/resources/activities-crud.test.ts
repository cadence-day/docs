...
describe("Activities API - CRUD Operations", () => {
  ...
  >;
  const mockDecryptActivityName =
    encryptionActivities.decryptActivityName as jest.MockedFunction<
      typeof encryptionActivities.decryptActivityName
    >;
  const mockEncryptActivityForInsertion =
    encryptionActivities.encryptActivityForInsertion as jest.MockedFunction<
      typeof encryptionActivities.encryptActivityForInsertion
    >;
  const mockEncryptActivitiesForInsertion =
    encryptionActivities.encryptActivitiesForInsertion as jest.MockedFunction<
      typeof encryptionActivities.encryptActivitiesForInsertion
    >;
  const mockEncryptActivityName =
    encryptionActivities.encryptActivityName as jest.MockedFunction<
  ...
  describe("Insert Operations", () => {
    describe("insertActivity", () => {
      it("should insert a single activity successfully", async () => {
        ...
        const mockInsertedActivity = createMockActivity(mockActivityInput);
      ...
      it("should handle insertion failure", async () => {
        ...
        mockEncryptActivityForInsertion.mockResolvedValue(mockActivityInput);
      ...
      it("should call supabase with correct parameters", async () => {
        ...
        expect(mockQuery.insert).toHaveBeenCalledWith(mockActivityInput);
    ...
    describe("upsertActivity", () => {
      it("should upsert an activity successfully", async () => {
        ...
        const mockUpsertedActivity = createMockActivity(mockActivityInput);
        ...
        expect(mockEncryptActivityName).toHaveBeenCalledWith(mockActivityInput);
      ...
      it("should call supabase with correct upsert parameters", async () => {
        ...
        expect(mockQuery.upsert).toHaveBeenCalledWith(mockUpsertedActivity, {
          onConflict: "id",
        });
      });
    });
  ...
  describe("Update Operations", () => {
    describe("updateActivity", () => {
      ...
      it("should call supabase with correct update parameters", async () => {
        ...
        expect(mockQuery.eq).toHaveBeenCalledWith("id", mockActivity.id);
        expect(mockQuery.select).toHaveBeenCalled();
        expect(mockQuery.single).toHaveBeenCalled();
      });
    });
  ...
  describe("Delete Operations", () => {
    ...
    describe("softDeleteActivities", () => {
      it("should soft delete multiple activities successfully", async () => {
        ...
        const result = await softDeleteActivities(["activity-1", "activity-2"]);
    ...
    describe("disableActivities", () => {
      it("should disable multiple activities successfully", async () => {
        ...
        const result = await disableActivities(["activity-1", "activity-2"]);
