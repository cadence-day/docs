  ...
  describe("Insert Operations", () => {
    describe("insertTimeslice", () => {
      it("should insert a single timeslice successfully", async () => {
        ...
        const mockInsertedTimeslice = createMockTimeslice(mockTimesliceInput);
      ...
      it("should call supabase with correct parameters", async () => {
        ...
        expect(mockSupabaseClient.from).toHaveBeenCalledWith("timeslices");
        expect(mockQuery.insert).toHaveBeenCalledWith(mockTimesliceInput);
    ...
    describe("upsertTimeslice", () => {
      it("should upsert a timeslice successfully", async () => {
        ...
        const mockUpsertedTimeslice = createMockTimeslice(mockTimesliceInput);
      ...
      it("should call supabase with correct upsert parameters", async () => {
        ...
        expect(mockQuery.upsert).toHaveBeenCalledWith(mockTimesliceInput, {
          onConflict: "id",
        });
      });
    });
  ...
  describe("Update Operations", () => {
    describe("updateTimeslice", () => {
      ...
      it("should call supabase with correct update parameters", async () => {
        ...
        expect(mockQuery.eq).toHaveBeenCalledWith("id", mockTimeslice.id);
        expect(mockQuery.select).toHaveBeenCalled();
        expect(mockQuery.single).toHaveBeenCalled();
      });
    });
  ...
  describe("Delete Operations", () => {
    ...
    describe("deleteTimeslices", () => {
      it("should delete multiple timeslices successfully", async () => {
        ...
        const result = await deleteTimeslices(["timeslice-1", "timeslice-2"]);
